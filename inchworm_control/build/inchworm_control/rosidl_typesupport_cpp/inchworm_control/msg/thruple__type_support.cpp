...
static const _Thruple_type_support_symbol_names_t _Thruple_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, inchworm_control, msg, Thruple)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, inchworm_control, msg, Thruple)),
  }
};
...
{
  return &::inchworm_control::msg::rosidl_typesupport_cpp::Thruple_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, inchworm_control, msg, Thruple)() {
  return get_message_type_support_handle<inchworm_control::msg::Thruple>();
}
