...
class MotorController(Node):
    ...
    def step_left_block(self):
        ...
        # mid-step allign
        theta1, theta2, theta3, theta4, theta5 = inverseKinematicsMQP(3.2,3.2,5.5,1)
        self.move_to(theta2, theta3, theta4+5, 1)

        # Place the EE to final pose 
        theta1, theta2, theta3, theta4, theta5 = inverseKinematicsMQP(3.2,3.2,3,1)
        self.move_to(theta2, theta3, theta4+5, 1)
        sleep(1)
        activate_servo(self.servo2)
        release_servo(self.servo1)
        ...
        # Second leg from here 
        theta1, theta2, theta3, theta4, theta5 = inverseKinematicsMQP(3.3,-3.3,4,5)
        self.move_to(theta2-10, theta3, theta4, 1)

        theta1, theta2, theta3, theta4, theta5 = inverseKinematicsMQP(3.1,-3,7,5)
        self.move_to(theta2-10, theta3, theta4, 1)

        theta1, theta2, theta3, theta4, theta5 = inverseKinematicsMQP(3.3,0,7,5)
        self.move_to(theta2, theta3, theta4, self.time_to_move)
        self.motor_1.move_time_write(theta1, self.time_to_move)
        self.motor_5.move_time_write(theta5-2, self.time_to_move)
        sleep(self.time_to_move)

        theta1, theta2, theta3, theta4, theta5 = inverseKinematicsMQP(3.5,0,4.5,5)
        self.move_to(theta2, theta3, theta4, self.time_to_move)
