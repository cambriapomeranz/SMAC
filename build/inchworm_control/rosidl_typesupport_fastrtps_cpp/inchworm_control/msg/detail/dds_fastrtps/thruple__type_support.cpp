...
#include "inchworm_control/msg/detail/thruple__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const inchworm_control::msg::Thruple *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<inchworm_control::msg::Thruple *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Thruple__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const inchworm_control::msg::Thruple *>(
...
{
  return max_serialized_size_Thruple(full_bounded, 0);
}

static message_type_support_callbacks_t _Thruple__callbacks = {
...
static rosidl_message_type_support_t _Thruple__handle = {
...
{
  return &inchworm_control::msg::typesupport_fastrtps_cpp::_Thruple__handle;
}
